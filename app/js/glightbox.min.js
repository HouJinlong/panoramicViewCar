!function(e, t) {
    ...
    function i(e, t) {
        if ((N.isNode(e) || e === window || e === document) && (e = [e]),
        N.isArrayLike(e) || N.isObject(e) || (e = [e]),
        0 != N.size(e))
            if (N.isArrayLike(e) && !N.isObject(e))
                for (var i = e.length, n = 0; n < i && !1 !== t.call(e[n], e[n], n, e); n++)
                    ;
            else if (N.isObject(e))
                for (var s in e)
                    if (N.has(e, s) && !1 === t.call(e[s], e[s], s, e))
                        break
    }
    function n(e) {
        function t(e) {
            N.isFunction(o) && o.call(c, e, this),
            r && t.destroy()
        }
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
          ...
          , c = arguments[2]
          , u = s || [];
        return N.isString(u) && (u = document.querySelectorAll(u)),
        t.destroy = function() {
            i(u, function(i) {
    ...
    function d(e, t) {
        for (; e !== document.body; )
            if ((e = e.parentElement).matches(t))
                return e
    }
    function c(e) {
    ...
    function h(e, i, n) {
        ...
        "vimeo" == l) {
            ...
            this.settings.autoplayVideos && (m.className += " wait-autoplay"),
            f(this.settings.vimeo.api, function() {
        ...
        if ("youtube" == l) {
            ...
            b.id = r,
            b.className = "youtube-video gvideo",
            this.settings.autoplayVideos && (b.className += " wait-autoplay"),
            f(this.settings.youtube.api, function() {
        ...
        if ("local" == l) {
            var S = '<video id="' + r + '" ';
            S += 'style="background:#000; width: ' + this.settings.width + "px; height: " + this.settings.height + 'px;" ',
            S += 'preload="metadata" ',
            S += 'x-webkit-airplay="allow" ',
            S += 'webkit-playsinline="" ',
            S += "controls ",
            S += 'class="gvideo">';
            var w = {
                mp4: "",
            ...
            for (var x in w)
                if (w.hasOwnProperty(x)) {
                    var k = w[x];
                    i.hasOwnProperty(x) && (k = i[x]),
                    "" !== k && (S += '<source src="' + k + '" type="video/' + x + '">')
                }
            var E = a(S += "</video>");
            d.appendChild(E);
            ...
            if (null !== this.settings.jwplayer && null !== this.settings.jwplayer.api) {
                ...
                f(A, function() {
                    ...
                    O[r] = i,
                    i.on("ready", function() {
                        s(C = d.querySelector(".jw-video"), "gvideo"),
                        C.id = r,
                        N.isFunction(n) && n()
                    })
                })
    ...
    function b(e, t) {
        ...
        n("ontouchend"in document ? "touchend" : "click", {
            ...
            withCallback: function(e, i) {
                ...
                s(C, "gdesc-open");
                var r = n("ontouchend"in document ? "touchend" : "click", {
                    onElement: [C, d(l, ".gslide-description")],
                    withCallback: function(e, i) {
                        "a" !== e.target.nodeName.toLowerCase() && (o(C, "gdesc-open"),
                        s(C, "gdesc-closed"),
    ...
    var N = {
      ...
      , L = function() {
        ...
        N.isNil(s)) {
            ...
            "" !== (s = s.replace(/'/g, '\\"')).trim() && (s = (s = s.split(";")).filter(Boolean)),
            i(s, function(e) {
                if (e = e.trim().split(":"),
                2 == N.size(e)) {
                    var t = e[0].trim()
        ...
        return u && (l.description = u.innerHTML),
        l
    }
      , I = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null
        ...
        "" == i.title && "" == i.description ? u && u.parentNode.removeChild(u) : (d && "" !== i.title ? d.innerHTML = i.title : d.parentNode.removeChild(d),
        c && "" !== i.description ? x ? (i.smallDescription = function(e) {
        ...
        }(i.description, 60, this.settings.moreText),
        c.innerHTML = i.smallDescription,
        b.apply(this, [c, i])) : c.innerHTML = i.description : c.parentNode.removeChild(c),
        s(a.parentNode, "desc-" + r),
        s(u, "description-" + r)),
        s(a, "gslide-" + o),
        s(e, "loaded"),
        "video" !== o)
            if ("external" !== o)
                if ("inline" !== o) {
                    ...
                    (function(e, t, i) {
                        ...
                        if (o) {
                            var l = o.cloneNode(!0);
                            return l.style.height = this.settings.height + "px",
                            l.style.maxWidth = this.settings.width + "px",
                            s(l, "ginlined-content"),
                            n.appendChild(l),
                            void (N.isFunction(i) && i())
                        }
                    }
                    ).apply(this, [e, i, f]);
            else {
    ...
    var B = function(e) {
      ...
      , M = function() {
        ...
        return S(e, [{
            ...
            value: function() {
                var e = this;
                this.baseEvents = n("ontouchend"in document ? "touchend" : "click", {
            ...
            value: function() {
                ...
                this.build(),
                r(this.overlay, this.settings.cssEfects.fade.in);
                var i = C.offsetWidth;
                if (C.style.width = i + "px",
                s(C, "glightbox-open"),
                s(E, "glightbox-open"),
                x && (s(E, "glightbox-mobile"),
                this.settings.slideEffect = "slide"),
                this.showSlide(t, !0),
                1 == this.elements.length ? (u(this.prevButton),
                u(this.nextButton)) : (c(this.prevButton),
                c(this.nextButton)),
                this.lightboxOpen = !0,
                N.isFunction(this.settings.onOpen) && this.settings.onOpen(),
                x && k)
                    return function() {
                        var e = this
                          , t = void 0
                        ...
                        this.events.doctouchmove = n("touchmove", {
                            onElement: document,
                            withCallback: function(e, t) {
                                if (l(C, "gdesc-open"))
                        ...
                        this.events.touchStart = n("touchstart", {
                            ...
                            withCallback: function(i, n) {
                                l(C, "gdesc-open") || (s(C, "touching"),
                                b = e.getActiveSlide(),
                                x = b.querySelector(".gslide-image"),
                                k = b.querySelector(".gslide-media"),
                                E = b.querySelector(".gslide-description"),
                                t = e.index,
                                p = i.targetTouches[0],
                                g.pageX = i.targetTouches[0].pageX,
                                g.pageY = i.targetTouches[0].pageY,
                                S = i.targetTouches[0].clientX,
                                w = i.targetTouches[0].clientY)
                            }
                        }),
                        ...
                        this.events.touchMove = n("touchmove", {
                            ...
                            withCallback: function(t, n) {
                                if (l(C, "touching") && !(l(C, "gdesc-open") || v || f)) {
                                    t.preventDefault(),
                                    p = t.targetTouches[0];
                                    var s = b?b.querySelector(".gslide-inner-content").offsetHeight:''
                                      , o = b?b.querySelector(".gslide-inner-content").offsetWidth:''
                                      , x = t.targetTouches[0].clientX
                                      , T = t.targetTouches[0].clientY
                                      , q = S - x
                                      , O = w - T;
                                    if (Math.abs(q) > Math.abs(O) ? (u = !1,
                                    h = !0) : (h = !1,
                                    u = !0),
                                    u) {
                                        if (d = r,
                        ...
                        this.events.touchEnd = n("touchend", {
                            ...
                            withCallback: function(t, n) {
                                ...
                                o(C, "touching");
                                var s = b?b.querySelector(".gslide-inner-content").offsetHeight:''
                                  , l = b?b.querySelector(".gslide-inner-content").offsetWidth:'';
                                if (u) {
                                    var a = s / 2;
                                    return u = !1,
                                    Math.abs(r) >= a ? void e.close() : void y(b)
                                }
                                if (h) {
                                    h = !1;
                                    var d = "prev"
                                    ...
                                    if (i < 0 && (d = "next",
                                    i = Math.abs(i)),
                                    "prev" == d && e.index - 1 < 0 && (v = !1),
                                    "next" == d && e.index + 1 >= e.elements.length && (v = !1),
                                    v && i >= l / 2 - 90)
                                        return void ("next" == d ? e.nextSlide() : e.prevSlide());
                                    y(b)
                                }
                            }
                        })
            ...
            value: function() {
                ...
                if (c(this.slidesContainer),
                l(r, "loaded"))
                    this.slideAnimateIn(r, i),
                    u(this.loader);
                else {
                    c(this.loader);
                    var a = L(this.elements[t]);
                    a.index = t,
                    I.apply(this, [r, a, function() {
                        u(e.loader),
                ...
                0 === t ? s(this.prevButton, "disabled") : t === this.elements.length - 1 && !0 !== this.settings.loopAtEnd && s(this.nextButton, "disabled"),
                this.activeSlide = r
            }
        }, {
            key: "preloadSlide",
            ...
            value: function(e, t) {
                ...
                if (n.offsetWidth > 0 && l && (u(l),
                e.querySelector(".ginner-container").style.maxWidth = n.offsetWidth + "px",
                l.style.display = ""),
                o(e, this.effectsClasses),
                t)
                    r(e, this.settings.openEffect, function() {
                        !x && i.settings.autoplayVideos && i.playSlideVideo(e),
                        N.isFunction(i.settings.afterSlideChange) && i.settings.afterSlideChange.apply(i, [a, d])
                    });
                else {
                    var c = this.settings.slideEffect
                      , h = this.settings.cssEfects[c].in;
                    this.prevActiveSlideIndex > this.index && "slide" == this.settings.slideEffect && (h = this.settings.cssEfects.slide_back.in),
                    r(e, h, function() {
                        !x && i.settings.autoplayVideos && i.playSlideVideo(e),
                        N.isFunction(i.settings.afterSlideChange) && i.settings.afterSlideChange.apply(i, [a, d])
                    })
            ...
            value: function() {
                ...
                N.isFunction(this.settings.beforeSlideChange) && this.settings.beforeSlideChange.apply(this, [{
                    index: this.prevActiveSlideIndex,
                    slide: this.prevActiveSlide
                }, {
                    index: this.index,
            ...
            value: function(e) {
                ...
                if (O && O.hasOwnProperty(i)) {
                    var n = O[i];
                    l(t, "vimeo-video") && n.pause(),
                    l(t, "youtube-video") && n.pauseVideo(),
                    l(t, "jw-video") && n.pause(!0),
                    l(t, "html5-video") && n.pause()
                }
            }
        }, {
            key: "playSlideVideo",
            value: function(e) {
                ...
                if (O && O.hasOwnProperty(i)) {
                    var n = O[i];
                    return l(t, "vimeo-video") && n.play(),
                    l(t, "youtube-video") && n.playVideo(),
                    l(t, "jw-video") && n.play(),
                    l(t, "html5-video") && n.play(),
                    setTimeout(function() {
                        o(t, "wait-autoplay")
                    }, 300),
                    !1
            ...
            value: function() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
                if (this.elements = [],
                !N.isNil(this.settings.elements) && N.isArray(this.settings.elements))
            ...
            value: function() {
                ...
                this.events = {},
                s(this.modal, "glightbox-" + this.settings.skin),
                this.settings.closeButton && l && (this.events.close = n("ontouchend"in document ? "touchend" : "click", {
                    onElement: l,
                    withCallback: function(t, i) {
                        t.preventDefault(),
                        e.close()
                ...
                this.nextButton && (this.events.next = n("ontouchend"in document ? "touchend" : "click", {
                ...
                this.prevButton && (this.events.prev = n("ontouchend"in document ? "touchend" : "click", {
            ...
            value: function() {
                ...
                s(this.modal, "glightbox-closing"),
                r(this.overlay, this.settings.cssEfects.fade.out),
                r(this.activeSlide, this.settings.cssEfects.zoom.out, function() {
                    ...
                    N.isFunction(e.settings.onClose) && e.settings.onClose()
                })
            }
        }, {
            key: "destroy",
